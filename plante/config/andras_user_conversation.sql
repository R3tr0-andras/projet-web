...
CREATE TABLE `user_conversation` (
  `user_conversationId` int NOT NULL AUTO_INCREMENT,
  `userId` int DEFAULT NULL,
  `conversationId` int DEFAULT NULL,
  PRIMARY KEY (`user_conversationId`),
  KEY `userId` (`userId`),
  KEY `conversationId` (`conversationId`),
  CONSTRAINT `user_conversation_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `user` (`userId`),
  CONSTRAINT `user_conversation_ibfk_2` FOREIGN KEY (`conversationId`) REFERENCES `conversation` (`conversationId`)
